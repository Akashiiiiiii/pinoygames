	...
	function signify_header_media_text() {
		...
		<div class="custom-header-content sections header-media-section content-align-left text-align-left">
			<div class="custom-header-content-wrapper">
				...
				?>
						<a href="http://sienna.inplay.ph/?o=pg" target="_blank" class="more-link" style="width:150px">Register<span class="screen-reader-text">Register</span></a>
						<a href="https://www.inplay.com.ph/?1362218875=&sess=801ec201-1079-11ed-b708-3ffd73a10ae5" target="_blank" class="more-link" style="width:150px">Login<span class="screen-reader-text">Login</span></a>
		...
		<div class="custom-header-content sections header-media-section content-align-center text-align-center">
			<div class="custom-header-content-wrapper" style="margin-top:150px !important">
				<?php
				if ( is_singular() && ! is_page() ) {
					signify_header_title( '<div class="section-title-wrapper"><h1 class="section-title">', '</h1></div>' );
				} else {
